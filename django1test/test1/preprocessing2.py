...
for edge in Edges.objects.all():
    ...
    srclab=int(srcnode.LABEL2)
    tarlab=int(tarnode.LABEL2)
    if srclab>tarlab:
        t=srclab
        srclab=tarlab
        tarlab=t
    if srcnode.LABEL2==tarnode.LABEL2:
        ...
        try:
            p=r1_edges.objects.get(SOURCE=srclab,TARGET=tarlab)
        except r1_edges.DoesNotExist:
            print ""
        else:
            edge2=edgedata(SOURCE=srcnode.ID,TARGET=tarnode.ID,LABEL=-23,CLUSTERSOURCE=srclab,CLUSTERTARGET=tarlab,WEIGHT=1,day1=0,day2=0,day3=0,day4=0,day5=0,day6=0,day7=0,day8=0,day9=0,day10=0,day11=0,day12=0,day13=0,day14=0,day15=0,week1=0,week2=0,week3=0,week4=0,month1=0,month2=0,month3=0)
            edge2.save()
            count=count+1
